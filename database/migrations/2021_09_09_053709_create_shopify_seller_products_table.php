...
class CreateShopifySellerProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shopify_seller_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shopify_seller_products');
    }
}
