                        ...
                        <div class="panel-body">
                            <table id="maintable" class="table table-striped table-hover table-responsive-sm">
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-default btn-xs" data-toggle="modal" data-target="#reset_pass_modal" onclick="settoken(this);"><i class="fa fa-key"></i> Reset Password</button></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
