    ...
    <aside class="navigation">
        <nav>
            <ul class="nav luna-nav">
                ...
                <li>
                    <a href="#beautyfort" data-toggle="collapse" aria-expanded="false">
                    Beauryfort<span class="sub-nav-icon"> <i class="stroke-arrow"></i> </span>
                    </a>
                    <ul id="beautyfort" class="nav nav-second collapse">
                        <li><a href="/allproducts">All Products</a></li>
                        <li><a href="/newstocks">New Stocks</a></li>
                        <li><a href="/removedproducts">Recently Removed Products</a></li>
                        <li><a href="/availablestocks">Available Stocks</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#ebay" data-toggle="collapse" aria-expanded="false">
                    Ebay<span class="sub-nav-icon"> <i class="stroke-arrow"></i> </span>
                    </a>
                    <ul id="ebay" class="nav nav-second collapse">
                        <li><a href="/ebaysellerproducts">Seller Products</a></li>
                        <li><a href="/ebayuploadeditems">Uploaded Items</a></li>
                        <li><a href="/ebayremoveditems">Removed Items</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#shopify" data-toggle="collapse" aria-expanded="false">
                        Shopify<span class="sub-nav-icon"> <i class="stroke-arrow"></i> </span>
                    </a>
                    <ul id="shopify" class="nav nav-second collapse">
                        <li><a href="/shopifyproducts">Seller Products</a></li>
                        <li><a href="/shopifyuploadeditems">Uploaded Items</a></li>
                        <li><a href="/shopifyremoveditems">Removed Items</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="settings" class="nav nav-second collapse">
                        <li><a href="/pricingstrategy">Pricing Strategy</a></li>
                        <li><a href="/quantitystrategy">Available Quantity Strategy</a></li>
                    </ul>
                </li>
                <li>
